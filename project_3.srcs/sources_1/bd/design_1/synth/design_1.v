...
module design_1
   (dip_switches_16bits_tri_i,
    ...
    dip_switches_16bits_tri_t,
    reset,
    sys_clock,
    usb_uart_rxd,
    usb_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 dip_switches_16bits TRI_I" *) input [7:0]dip_switches_16bits_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 dip_switches_16bits TRI_O" *) output [7:0]dip_switches_16bits_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 dip_switches_16bits TRI_T" *) output [7:0]dip_switches_16bits_tri_t;
  ...
  assign axi_gpio_0_GPIO_TRI_I = dip_switches_16bits_tri_i[7:0];
  assign axi_uartlite_0_UART_RxD = usb_uart_rxd;
  assign dip_switches_16bits_tri_o[7:0] = axi_gpio_0_GPIO_TRI_O;
  assign dip_switches_16bits_tri_t[7:0] = axi_gpio_0_GPIO_TRI_T;
